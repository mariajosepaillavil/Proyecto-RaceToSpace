...
import "../css/JuegoPizarra.css";


function JuegoPizarra() {
    ...
    return (
        ...
        <div className="pizarra">
            <section className="tools-board">
                <div className="row">
                    <label className="title">Figuras</label>
                ...
                <div className="row">
                    <label className="title">Opciones</label>
                    <ul className="options">
                ...
                <div className="row colors">
                    <label className="title">Colores</label>
                    <ul className="options">
                ...
                <div className="row buttons">
                    <button className="clear-canvas">Limpiar Pizarra</button>
                    <button className="save-img">Guardar</button>
                </div>
            </section>
